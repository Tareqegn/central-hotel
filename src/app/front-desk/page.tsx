// Front Desk Check-In & Guest Profile Management Portal
"use client";
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4 border-b border-white/[0.08] pb-6">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 rounded-xl bg-[#18181b] border border-white/[0.08] flex items-center justify-center p-2 shadow-md">
              <span className="text-amber-400 font-mono font-bold text-lg">FD</span>
            </div>
            <div>
              ...
              <h1 className="text-2xl sm:text-3xl font-serif text-white tracking-wide">Central Hotel — Front Desk Portal</h1>
            </div>
          </div>

          <div className="flex items-center gap-3 bg-[#18181b] px-3 py-2 rounded-xl border border-white/[0.08]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-[#18181b] border border-white/[0.08] p-6 rounded-2xl shadow-xl h-fit">
            ...
            <form onSubmit={handleCheckIn} className="space-y-4">
              ...
              <div>
                <label className="block text-[10px] font-mono uppercase tracking-wider text-neutral-400 mb-1">Preferences & History Memory</label>
                <textarea
                  placeholder="e.g. Enjoyed the spa last stay, prefers extra feather pillows, allergic to shellfish..."
                  value={preferences}
          ...
          <div className="lg:col-span-2 bg-[#18181b] border border-white/[0.08] p-6 rounded-2xl shadow-xl">
            <h2 className="text-xs font-mono uppercase tracking-widest text-amber-400 font-semibold mb-4 flex items-center justify-between">
              ...
              <span className="text-[10px] text-neutral-400 font-normal">Synced live to Manager Dashboard</span>
            </h2>
                ...
                filteredProfiles.map((p) => (
                  <div 
                    ...
                    className={`p-4 rounded-xl border flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 transition-all ${
                      p.is_checked_in ? 'bg-[#202024] border-amber-500/30' : 'bg-[#151518] border-white/[0.04] opacity-60'
                    }`}
                  >
